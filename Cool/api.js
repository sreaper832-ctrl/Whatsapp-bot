...
const APIs = {
  ...
  // Compatibility aliases used by case.js
  getEliteProTechAudioByUrl: async (youtubeUrl) => APIs.getEliteProTechDownloadByUrl(youtubeUrl),
  getYupraAudioByUrl: async (youtubeUrl) => APIs.getYupraDownloadByUrl(youtubeUrl),
  getOkatsuAudioByUrl: async (youtubeUrl) => APIs.getOkatsuDownloadByUrl(youtubeUrl),
