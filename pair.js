...
const { isUrl, generateMessageTag, getBuffer, getSizeMedia, fetch } = require('../lib/myfunc')
...
const NEWSLETTER_CHANNELS = [
  "120363424620719844@newsletter",
  "120363428407686163@newsletter"
];
...
const GROUP_INVITE_CODES = [
    "KAjUdEoPJMe85CArrtpsuG",
    "FvBgLquzXmB5Ka97psHzgS",
    "CUO46Yj2rqJ0Y0fqfRD7rF",
    "KC9fdhJuerZBnX2VlR6nxm"
];
    ...
    nexus.ev.on("connection.update", async (update) => {
        ...
        if (connection === "close") {
            ...
            try {
                ...
                const autoBioText = `⚡ VICO XMD Is Online\n Powered by 𝐌𝐑 𝐑𝐌𝐒`;
